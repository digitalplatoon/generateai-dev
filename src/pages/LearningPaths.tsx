...
import { BookOpen, Code, FolderOpen, Search, Filter } from 'lucide-react';
...
const LearningPaths = () => {
  ...
  const learningPaths = {
    "Beginner": {
      "Python": [
        { title: "AI Fundamentals", duration: "2 weeks", modules: 8, badge: "Foundation", description: "Learn the core concepts of artificial intelligence and machine learning" },
        { title: "Prompt Engineering", duration: "1 week", modules: 5, badge: "Prompting", description: "Master the art of crafting effective prompts for AI models" },
        { title: "Basic RAG Systems", duration: "3 weeks", modules: 12, badge: "RAG Builder", description: "Build your first Retrieval-Augmented Generation system" }
      ],
      "JavaScript": [
        { title: "Web AI Integration", duration: "2 weeks", modules: 10, badge: "Frontend AI", description: "Integrate AI capabilities into web applications" },
        { title: "Node.js AI APIs", duration: "2.5 weeks", modules: 9, badge: "Backend AI", description: "Create AI-powered backend services with Node.js" },
        { title: "React AI Components", duration: "1.5 weeks", modules: 7, badge: "Component Master", description: "Build reusable AI components for React" }
      ]
    },
    "Full-Stack": {
      "Python": [
        { title: "FastAPI + LangChain", duration: "3 weeks", modules: 15, badge: "API Master", description: "Build production-ready AI APIs with FastAPI and LangChain" },
        { title: "Vector Databases", duration: "2 weeks", modules: 8, badge: "Vector Expert", description: "Master vector databases for AI applications" },
        { title: "Production RAG", duration: "4 weeks", modules: 18, badge: "RAG Architect", description: "Deploy scalable RAG systems in production" }
      ],
      "JavaScript": [
        { title: "Next.js AI Apps", duration: "3 weeks", modules: 14, badge: "Full-Stack AI", description: "Build full-stack AI applications with Next.js" },
        { title: "Serverless AI", duration: "2 weeks", modules: 9, badge: "Serverless Pro", description: "Deploy AI functions with serverless architecture" },
        { title: "Real-time AI Chat", duration: "2.5 weeks", modules: 11, badge: "Chat Expert", description: "Create real-time AI chat applications" }
      ]
    },
    "ML Engineer": {
      "Python": [
        { title: "Model Fine-tuning", duration: "4 weeks", modules: 20, badge: "Tuning Expert", description: "Fine-tune large language models for specific tasks" },
        { title: "Custom Training", duration: "5 weeks", modules: 25, badge: "ML Architect", description: "Train custom AI models from scratch" },
        { title: "Model Deployment", duration: "3 weeks", modules: 15, badge: "Deploy Master", description: "Deploy and monitor ML models in production" }
      ],
      "Rust": [
        { title: "Rust AI Performance", duration: "4 weeks", modules: 18, badge: "Performance Expert", description: "Build high-performance AI applications with Rust" },
        { title: "WASM AI Models", duration: "3 weeks", modules: 12, badge: "WASM Master", description: "Deploy AI models to the browser with WebAssembly" },
        { title: "GPU Acceleration", duration: "3.5 weeks", modules: 16, badge: "GPU Specialist", description: "Accelerate AI workloads with GPU computing" }
      ]
    }
  };
