...
const Cookies = () => {
  ...
  return (
    <>
      <SEOHead
        title="Cookie Policy - GenerateAI.dev"
        description="Learn how GenerateAI.dev uses cookies and similar technologies to enhance your experience, analyze site traffic, and deliver personalized content."
        keywords="cookie policy, cookies, privacy, browser cookies, analytics"
        canonical="https://generateai.dev/cookies"
      />
