...
const Community = () => {
  const communitySchema = {
    ...
    "@type": "Organization",
    "name": "GenerateAI.dev Community",
    "description": "Join our vibrant community of AI developers. Connect, share knowledge, and build the future of AI together.",
    "url": "https://generateai.dev/community",
    "memberOf": {
      "@type": "Organization",
      "name": "GenerateAI.dev"
    }
  ...
  return (
    <>
      <SEOHead
        title="Community - Join AI Developers Worldwide"
        description="Join our vibrant community of 12,500+ AI developers. Connect, share knowledge, and build the future of AI together through Discord, GitHub, and monthly events."
        keywords="AI community, developer community, Discord, GitHub, AI meetups, networking, collaboration"
        schema={communitySchema}
        canonical="https://generateai.dev/community"
      />
